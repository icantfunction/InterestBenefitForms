...
<body class="bg-gray-100 text-lg">
    <div class="w-full max-w-2xl mx-auto mt-10">
        ...
        <div class="mb-6">
            ...
            <h2 class="text-xl font-semibold text-gray-700">What is your household income?</h2>
        </div>
        <!-- Form Card -->
        <div class="bg-white border border-gray-300 rounded-lg overflow-hidden">
            <div class="bg-blue-800 p-6 flex justify-between items-center">
                <h2 class="text-white font-semibold text-2xl">Income</h2>
        ...
        <div class="flex justify-between space-x-4 mt-4">
            <a href="FirstFormPage.html" class="w-1/2 flex items-center justify-center px-6 border border-blue-500 text-blue-400 hover:bg-blue-500 hover:text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                BACK
            </a>
            <a href="ThirdFormPage.html" class="w-1/2 flex items-center justify-center py-4 px-6 border border-blue-500 text-blue-400 hover:bg-blue-500 hover:text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                CONTINUE
            </a>
        </div>
    </div>
